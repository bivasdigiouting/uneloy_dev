...
class ECardSevaOtherPointsReportController extends Controller
{
    protected ECardSevaOtherPointsRepositoryInterface $repo;

    public function __construct(ECardSevaOtherPointsRepositoryInterface $repo)
    {
        $this->repo = $repo;
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.benefits.ecard-seva-other-points-report.index', compact('statuses', 'bloodGroups'));
    }
