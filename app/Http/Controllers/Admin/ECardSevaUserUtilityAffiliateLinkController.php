...
class ECardSevaUserUtilityAffiliateLinkController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.ecard-seva-user-utility-affiliate-links.index', compact('states'));
    }
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::eloquent($query)
            ...
            ->addColumn('action', function ($row) {
                $deleteUrl = route('admin.ecard-seva-user-utility-affiliate-links.destroy', $row->id);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('admin.ecard-seva-user-utility-affiliate-links.index')
