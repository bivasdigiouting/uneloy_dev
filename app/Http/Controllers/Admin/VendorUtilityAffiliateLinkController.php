...
class VendorUtilityAffiliateLinkController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.vendor_utility_affiliate_links.index', compact('states'));
    }

    public function data(Request $request)
    {
        $query = $this->repo->queryForDataTable()->where('audience_type', 'Vendor');
        ...
        return DataTables::eloquent($query)
            ...
            ->addColumn('action', function ($row) {
                $deleteUrl = route('admin.vendor.utility-affiliate-links.destroy', $row->id);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('admin.vendor.utility-affiliate-links.index')
            ->with('success', 'Vendor Utility & Affiliate Link added successfully.');
    }
