...
document.querySelector("html").setAttribute("data-theme", localStorage.getItem('admin_theme') || 'light');
document.querySelector("html").setAttribute('data-sidebar', localStorage.getItem('admin_sidebarTheme') || 'light');
document.querySelector("html").setAttribute('data-color', localStorage.getItem('admin_color') || 'primary');
document.querySelector("html").setAttribute('data-topbar', localStorage.getItem('admin_topbar') || 'white');
document.querySelector("html").setAttribute('data-layout', localStorage.getItem('admin_layout') || 'default');
document.querySelector("html").setAttribute('data-topbarcolor', localStorage.getItem('admin_topbarcolor') || 'white');
document.querySelector("html").setAttribute('data-card', localStorage.getItem('admin_card') || 'bordered');
document.querySelector("html").setAttribute('data-size', localStorage.getItem('admin_size') || 'default');
document.querySelector("html").setAttribute('data-width', localStorage.getItem('admin_width') || 'fluid');
document.querySelector("html").setAttribute('data-loader', localStorage.getItem('admin_loader') || 'enable');
...
let themesettings = `
    ...
    document.addEventListener("DOMContentLoaded", function() {
		...
		const darkMode = localStorage.getItem('admin_darkMode');
	
		function enableDarkMode() {  
            document.documentElement.setAttribute('data-theme', 'dark');
			darkModeToggle.classList.remove('activate');
			lightModeToggle.classList.add('activate');
			localStorage.setItem('admin_darkMode', 'enabled');
		}
		...
		function disableDarkMode() {
			...
			localStorage.removeItem('admin_darkMode');
		}
        ...
        function setThemeAndSidebarTheme(theme, sidebarTheme, color, layout, topbar, topbarcolor, card, size, width, loader) {
            ...
            localStorage.setItem('admin_sidebarTheme', sidebarTheme);
            localStorage.setItem('admin_color', color);
            localStorage.setItem('admin_layout', layout);
            localStorage.setItem('admin_topbar', topbar);
            localStorage.setItem('admin_topbarcolor', topbarcolor);
            localStorage.setItem('admin_card', card);
            localStorage.setItem('admin_size', size);
            localStorage.setItem('admin_width', width);
            localStorage.setItem('admin_loader', loader);
            //localStorage.removeItem('admin_primaryRGB');
        ...
        function handleSidebarBgChange() {
            ...
            if (sidebarBg) {
                ...
                localStorage.setItem('admin_sidebarBg', sidebarBg);
            } else {
                document.body.removeAttribute('data-sidebarbg');
                localStorage.removeItem('admin_sidebarBg');
            }
        }
        ...
        function handleTopbarBgChange() {
            ...
            if (topbarbg) {
                ...
                localStorage.setItem('admin_topbarbg', topbarbg);
            } else {
                document.body.removeAttribute('data-topbarbg');
                localStorage.removeItem('admin_topbarbg');
            }
        }
        ...
        function handleInputChange() {
            ...
            color = localStorage.getItem('admin_primaryRGB');
            sidebarTheme = localStorage.getItem('admin_sidebarRGB');
            topbar = localStorage.getItem('admin_topbarRGB');
            topbarcolor = localStorage.getItem('admin_topbarcolorRGB');
        ...
        savedSidebarTheme = localStorage.getItem('admin_sidebarTheme');
        savedColor = localStorage.getItem('admin_color');
        const savedLayout = localStorage.getItem('admin_layout') || 'default';
        savedTopbar = localStorage.getItem('admin_topbar');
        savedTopbarcolor = localStorage.getItem('admin_topbarcolor');
        const savedCard = localStorage.getItem('admin_card') || 'bordered';
        const savedSize = localStorage.getItem('admin_size') || 'default';
        const savedWidth = localStorage.getItem('admin_width') || 'fluid';
        const savedLoader = localStorage.getItem('admin_loader') || 'enable';
        const savedSidebarBg = localStorage.getItem('admin_sidebarBg') || null;
        const savedTopbarBg = localStorage.getItem('admin_topbarbg') || null;

        // setup theme color all
        const savedColorPickr = localStorage.getItem('admin_primaryRGB') 
        ...
        const savedTopbarPickr = localStorage.getItem('admin_topbarRGB') 
        ...
        }else if((savedTopbarPickr != null) && (savedTopbar == null))
        {
         ...
         const savedTopbarcolorPickr = localStorage.getItem('admin_topbarcolorRGB') 
        ...
        // setup theme color all
        const savedSidebarPickr = localStorage.getItem('admin_sidebarRGB') 
