...
document.querySelector("html").setAttribute("data-theme", localStorage.getItem('ecard_theme') || 'light');
document.querySelector("html").setAttribute('data-sidebar', localStorage.getItem('ecard_sidebarTheme') || 'light');
document.querySelector("html").setAttribute('data-color', localStorage.getItem('ecard_color') || 'primary');
document.querySelector("html").setAttribute('data-topbar', localStorage.getItem('ecard_topbar') || 'white');
document.querySelector("html").setAttribute('data-layout', localStorage.getItem('ecard_layout') || 'default');
document.querySelector("html").setAttribute('data-width', localStorage.getItem('ecard_width') || 'fluid');
...
<div class="sidebar-contact ">
    ...
    <div class="themecard-body offcanvas-body">
                                ...
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="defaultLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="/backend_assets/assets/img/icons/dash1.svg" alt="img">
                                        </span>                                     
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="miniLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="/backend_assets/assets/img/icons/dash2.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="twocolumnLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="/backend_assets/assets/img/icons/dash3.svg" alt="img">
                                        </span>                                    
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontalLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="/backend_assets/assets/img/icons/dash4.svg" alt="img">
                                        </span>                                    
        ...
        <div class="p-3 pt-0">
            <div class="row gx-3">
                ...
                <div class="col-6">
                    <a href="#" id="saveThemeBtn" class="btn btn-primary w-100" data-bs-dismiss="offcanvas"><i class="ti ti-shopping-cart-plus me-1"></i>Save Change</a>
                </div>
            </div>
        </div>    
    </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
		...
		const darkMode = localStorage.getItem('ecard_darkMode');
	
		function enableDarkMode() {  
            document.documentElement.setAttribute('data-theme', 'dark');
			darkModeToggle.classList.remove('activate');
			lightModeToggle.classList.add('activate');
			localStorage.setItem('ecard_darkMode', 'enabled');
		}
		...
		function disableDarkMode() {
			...
			localStorage.removeItem('ecard_darkMode');
		}
        ...
        function setThemeAndSidebarTheme(theme, sidebarTheme, color, layout, topbar, width) {
            ...
            localStorage.setItem('ecard_theme', theme);
            localStorage.setItem('ecard_sidebarTheme', sidebarTheme);
            localStorage.setItem('ecard_color', color);
            localStorage.setItem('ecard_layout', layout);
            localStorage.setItem('ecard_topbar', topbar);
            localStorage.setItem('ecard_width', width);
            //localStorage.removeItem('ecard_primaryRGB');
        ...
        function handleSidebarBgChange() {
            ...
            if (sidebarBg) {
                ...
                localStorage.setItem('ecard_sidebarBg', sidebarBg);
            } else {
                document.body.removeAttribute('data-sidebarbg');
                localStorage.removeItem('ecard_sidebarBg');
            }
        }
        ...
        function handleTopbarBgChange() {
            ...
            if (topbarbg) {
                ...
                localStorage.setItem('ecard_topbarbg', topbarbg);
            } else {
                document.body.removeAttribute('data-topbarbg');
                localStorage.removeItem('ecard_topbarbg');
            }
        }
        ...
        function handleInputChange() {
            ...
            color = localStorage.getItem('ecard_primaryRGB');
            sidebarTheme = localStorage.getItem('ecard_sidebarRGB');
            topbar = localStorage.getItem('ecard_topbarRGB');
        ...
        const savedTheme = localStorage.getItem('ecard_theme') || 'light';
        savedSidebarTheme = localStorage.getItem('ecard_sidebarTheme');
        savedColor = localStorage.getItem('ecard_color');
        const savedLayout = localStorage.getItem('ecard_layout') || 'default';
        savedTopbar = localStorage.getItem('ecard_topbar');
        const savedWidth = localStorage.getItem('ecard_width') || 'fluid';
        const savedSidebarBg = localStorage.getItem('ecard_sidebarBg') || null;
        const savedTopbarBg = localStorage.getItem('ecard_topbarbg') || null;

        // setup theme color all
        const savedColorPickr = localStorage.getItem('ecard_primaryRGB') 
        ...
        const savedTopbarPickr = localStorage.getItem('ecard_topbarRGB') 
        ...
        // setup theme color all
        const savedSidebarPickr = localStorage.getItem('ecard_sidebarRGB') 
        ...
        if (resetButton) {
            resetButton.addEventListener('click', function() {
                localStorage.removeItem('ecard_theme');
localStorage.removeItem('ecard_sidebarTheme');
localStorage.removeItem('ecard_color');
localStorage.removeItem('ecard_layout');
localStorage.removeItem('ecard_topbar');
localStorage.removeItem('ecard_width');
localStorage.removeItem('ecard_sidebarBg');
localStorage.removeItem('ecard_topbarbg');
localStorage.removeItem('ecard_primaryRGB');
localStorage.removeItem('ecard_sidebarRGB');
localStorage.removeItem('ecard_topbarRGB');
localStorage.removeItem('ecard_darkMode');
        ...
        if (saveThemeBtn && window.saveThemeRoute) {
            saveThemeBtn.addEventListener('click', function(e) {
                // e.preventDefault(); // Don't prevent default as it might close offcanvas

                const themeSettings = {
                    theme: localStorage.getItem('ecard_theme'),
                    sidebarTheme: localStorage.getItem('ecard_sidebarTheme'),
                    color: localStorage.getItem('ecard_color'),
                    topbar: localStorage.getItem('ecard_topbar'),
                    layout: localStorage.getItem('ecard_layout'),
                    width: localStorage.getItem('ecard_width'),
                    sidebarBg: localStorage.getItem('ecard_sidebarBg'),
                    topbarbg: localStorage.getItem('ecard_topbarbg'),
                    primaryRGB: localStorage.getItem('ecard_primaryRGB'),
                    darkMode: localStorage.getItem('ecard_darkMode'),
                };

                fetch(window.saveThemeRoute, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': window.csrfToken
                    },
                    body: JSON.stringify({ theme_settings: themeSettings })
                })
