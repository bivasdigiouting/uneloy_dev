@php
    ...
    $pageTitle = $siteName.' · '.$portalLabel.' · 419 Page Expired';
@endphp
            ...
            <div class="row g-0">
                <div class="col-lg-7 p-4 p-md-5">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="error-desc">
                            Your session may have expired or the page was open for too long.
                    ...
                    <div class="mt-4 hint">
                        If you were submitting a form, please reload the page and try again.
                    </div>
                </div>
                <div class="col-lg-5 p-4 p-md-5">
                    <div class="error-illustration d-flex flex-column justify-content-between">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="text-secondary fw-semibold">Status: 419</div>
                        </div>
                        <div class="orbit">
                            <div class="dot"></div>
                        ...
                        <div class="text-secondary" style="font-size: 13px;">
                            Returning to the dashboard will re-establish a fresh session if needed.
                        </div>
                    </div>
                </div>
            </div>
