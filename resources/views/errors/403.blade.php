@php
    ...
    $pageTitle = $siteName.' · '.$portalLabel.' · 403 Forbidden';
@endphp
                ...
                <div class="col-lg-5 p-4 p-md-5">
                    <div class="error-illustration d-flex flex-column justify-content-between">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="fw-bold">Authorization</div>
                            <div class="text-secondary fw-semibold">Status: 403</div>
                        </div>
                        <div class="orbit">
                            <div class="dot"></div>
                        ...
                        <div class="text-secondary" style="font-size: 13px;">
                            Your account may not have access to this resource. Please return to a safe page.
                        </div>
                    </div>
                </div>
            </div>
