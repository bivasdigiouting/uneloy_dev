@php
    ...
    $pageTitle = $siteName.' · '.$portalLabel.' · 500 Server Error';
@endphp
        ...
        <div class="error-card">
            <div class="row g-0">
                <div class="col-lg-7 p-4 p-md-5">
                    ...
                    <div class="mt-4 hint">
                        If this keeps happening, please refresh the page and try again in a moment.
                    </div>
                </div>
                <div class="col-lg-5 p-4 p-md-5">
                    <div class="error-illustration d-flex flex-column justify-content-between">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="text-secondary fw-semibold">Status: 500</div>
                        </div>
                        <div class="orbit">
                            <div class="dot"></div>
                        ...
                        <div class="text-secondary" style="font-size: 13px;">
                            Your data is safe. This is an internal error and we’ll resolve it as soon as possible.
                        </div>
                    </div>
                </div>
            </div>
