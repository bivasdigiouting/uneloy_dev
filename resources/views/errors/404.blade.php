@php
    ...
    $pageTitle = $siteName.' · '.$portalLabel.' · 404 Not Found';
@endphp
                ...
                <div class="col-lg-7 p-4 p-md-5">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="error-desc">
                            ...
                            You can go back to the previous page or return to your dashboard.
                        </p>
                    </div>
                    ...
                    <div class="mt-4 hint">
                        If you typed the address manually, please double-check the URL and try again.
                    </div>
                </div>
                <div class="col-lg-5 p-4 p-md-5">
                    <div class="error-illustration d-flex flex-column justify-content-between">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="text-secondary fw-semibold">Status: 404</div>
                        </div>
                        <div class="orbit">
                            <div class="dot"></div>
                        ...
                        <div class="text-secondary" style="font-size: 13px;">
                            Need help? Try returning to the dashboard and continue from there.
                        </div>
                    </div>
                </div>
            </div>
