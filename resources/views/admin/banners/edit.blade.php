                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('banner_type') is-invalid @enderror" 
                                        ...
                                        <option value="home_1" {{ old('banner_type', $banner->banner_type) == 'home_1' ? 'selected' : '' }}>Home 1</option>
                                        <option value="home_2" {{ old('banner_type', $banner->banner_type) == 'home_2' ? 'selected' : '' }}>Home 2</option>
                                        <option value="home_3" {{ old('banner_type', $banner->banner_type) == 'home_3' ? 'selected' : '' }}>Home 3</option>
                                        <option value="my_order" {{ old('banner_type', $banner->banner_type) == 'my_order' ? 'selected' : '' }}>My Order</option>
                                        <option value="deposit" {{ old('banner_type', $banner->banner_type) == 'deposit' ? 'selected' : '' }}>Deposit</option>
                                        <option value="withdrawal" {{ old('banner_type', $banner->banner_type) == 'withdrawal' ? 'selected' : '' }}>Withdrawal</option>
                                        <option value="rewards" {{ old('banner_type', $banner->banner_type) == 'rewards' ? 'selected' : '' }}>Rewards</option>
                                    </select>
                                    @error('banner_type')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="border rounded p-3 text-center" style="min-height: 150px;">
                                        @if($banner->image)
                                            ...
                                            <div id="noImageText" class="text-muted d-none">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-check"></i> Update Banner
                                    </button>
                                </div>
                            </div>
                        </div>
...
function previewImage(input) {
    ...
    if (input.files && input.files[0]) {
        ...
        // If no file selected, show current image or no image text
        @if($banner->image)
