...
@section('title', 'Edit Panchayat')

@section('content')
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Edit Panchayat</h2>
            <nav>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.panchayats.update', $row->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="panchayat_name" class="form-control" value="{{ old('panchayat_name', $row->panchayat_name) }}" required>
