...
@section('title', 'Add Panchayat')

@section('content')
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Add Panchayat</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="ti ti-smart-home"></i></a></li>
                    <li class="breadcrumb-item">Master Modules</li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.panchayats.index') }}">Panchayat Master</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.panchayats.store') }}">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Panchayat Name <span class="text-danger">*</span></label>
                                <input type="text" name="panchayat_name" class="form-control" value="{{ old('panchayat_name') }}" required>
                                @error('panchayat_name')<div class="text-danger">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mt-4">
                            <button class="btn btn-primary" type="submit"><i class="ti ti-device-floppy"></i> Save</button>
                            <a href="{{ route('admin.panchayats.index') }}" class="btn btn-light">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
