...
@section('title', 'Vendor Notification Master')
...
<div class="content container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Vendor Notification Master</h3>
                <ul class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Vendor Notification</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.vendor.notification-master.store') }}" method="POST" id="vendorNotificationForm" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Vendor Notifications</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="vendorNotificationMasterTable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>Sr. No.</th>
                                    <th>Type</th>
...
$(function(){
    ...
    // DataTable
    const table = $('#vendorNotificationMasterTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route('admin.vendor.notification-master.data') }}',
        order: [[6, 'desc']],
        columns: [
...
window.deleteVendorNotification = function(id) {
    if (!confirm('Delete this notification?')) return;
    $.ajax({
        url: '{{ route('admin.vendor.notification-master.destroy', ['id' => '__ID__']) }}'.replace('__ID__', id),
        type: 'DELETE',
        data: { _token: '{{ csrf_token() }}' }
    }).done(function(){ $('#vendorNotificationMasterTable').DataTable().ajax.reload(null, false); });
};
</script>
@endpush