									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li><a href="{{ route('admin.settings.third-party-api.show') }}">Third Party Api Settings</a></li>
												<li><a href="{{ route('admin.settings.recharge-api.show') }}">Recharge API Settings</a></li>
												<li><a href="otp-settings.html">OTP</a></li>
												<li><a href="gdpr.html">GDPR Cookies</a></li>
												<li><a href="{{ route('admin.settings.maintenance.show') }}">Maintenance Mode</a></li>
											</ul>
										</li>
														<li class="submenu">
															<a href="javascript:void(0);">Financial Settings<span class="menu-arrow"></span></a>
															<ul>
<li><a href="{{ route('admin.payment-gateways.index') }}">Payment Gateways</a></li>
																<li><a href="{{ route('admin.gst-taxes.index') }}">Tax Rate</a></li>
								...
								<div class="dropdown-menu shadow-none">
									<div class="card mb-0">
										<div class="card-header">
											<div class="d-flex align-items-center">
												...
												<div>
													...
													<p class="fs-12 fw-medium mb-0"><a href="https://smarthr.co.in/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fd8a9c8f8f9893bd98859c908d9198d39e9290">[email&#160;protected]</a></p>
												</div>
											</div>
										</div>
										<div class="card-body">
										...
										<div class="card-footer">
											<a class="dropdown-item d-inline-flex align-items-center p-0 py-2" href="javascript:void(0);" onclick="confirmAdminLogout()">
				...
				<div class="dropdown mobile-user-menu">
					...
					<div class="dropdown-menu dropdown-menu-end">
						...
						<a class="dropdown-item" href="javascript:void(0);" onclick="confirmAdminLogout()">Logout</a>
					</div>
				</div>
				<!-- /Mobile Menu -->
