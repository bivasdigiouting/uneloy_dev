            ...
            <form action="{{ route('admin.cms-pages.store') }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" class="form-control" required placeholder="Enter page title">
                    </div>
                    
                    <div class="col-md-6">
                        <label for="slug" class="form-label">Page Slug (Optional)</label>
                        <input type="text" name="slug" id="slug" value="{{ old('slug') }}" class="form-control" placeholder="Leave blank to auto-generate from title">
