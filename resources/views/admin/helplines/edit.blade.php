...
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Edit Helpline</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Helpline</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.helplines.update', $helpline->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Helpline Name <span class="text-danger">*</span></label>
                        <input type="text" name="helpline_name" class="form-control" value="{{ old('helpline_name', $helpline->helpline_name) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="helpline_number" class="form-control" value="{{ old('helpline_number', $helpline->helpline_number) }}" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="state_id" id="stateSelect" class="form-select" required>
                            ...
                            @foreach($states as $state)
                                <option value="{{ $state->id }}" @selected(old('state_id', $helpline->state_id) == $state->id)>{{ $state->state_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="district_id" id="districtSelect" class="form-select" required>
                            ...
                            @foreach($districts as $district)
                                <option value="{{ $district->id }}" @selected(old('district_id', $helpline->district_id) == $district->id)>{{ $district->district_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="city_id" id="citySelect" class="form-select" required>
                            ...
                            @foreach($cities as $city)
                                <option value="{{ $city->id }}" @selected(old('city_id', $helpline->city_id) == $city->id)>{{ $city->city_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mt-2">
                            <img id="iconPreview" src="{{ $helpline->icon_url }}" alt="Preview" style="{{ $helpline->icon_url ? '' : 'display:none;' }}width:48px;height:48px" class="img-thumbnail">
                        </div>
