...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" href="{{ isset($settings) && $settings->favicon ? asset('storage/'.$settings->favicon) : asset('backend-assets/img/favicon.png') }}" type="image/x-icon">
	<link rel="shortcut icon" href="{{ isset($settings) && $settings->favicon ? asset('storage/'.$settings->favicon) : asset('backend-assets/img/favicon.png') }}" type="image/x-icon">
