...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Create New Product Category</h2>
            <nav>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.product-categories.store') }}" method="POST" enctype="multipart/form-data" id="productCategoryForm">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <small class="form-text text-muted">Recommended size: 64x64 pixels. Supported formats: JPG, PNG, SVG</small>
                                        @error('icon')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        ...
                                        <div id="iconPreview" class="mt-3" style="display: none;">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <h6 class="mb-1">Icon Preview</h6>
                                                    <small class="text-muted">This is how your icon will appear</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-check me-1"></i> Create Product Category
                                    </button>
                                </div>
                            </div>
                        </div>
