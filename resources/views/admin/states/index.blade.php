...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">State Management</h2>
            <nav>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="statesTable" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>State Name</th>
...
$(document).ready(function() {
    ...
    var table = $('#statesTable').DataTable({
        ...
        order: [[1, 'asc']], // Sort by state_name
        pageLength: 25,
