...
@section('title', 'Edit Special Feature')
...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Edit Special Feature</h2>
            <nav>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Edit Special Feature</h5>
                    <a href="{{ route('admin.special-features.index') }}" class="btn btn-secondary">
                        <i class="ti ti-arrow-left"></i> Back to Special Features
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.special-features.update', $feature->id) }}" method="POST" enctype="multipart/form-data" id="specialFeatureForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="features_name" 
                                           name="features_name" 
                                           value="{{ old('features_name', $feature->features_name) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="sequence" 
                                           name="sequence" 
                                           value="{{ old('sequence', $feature->sequence) }}" 
                                           min="1"
                                ...
                                @if($feature->icon_url)
                                    <div class="mb-3" id="currentIcon">
                                        ...
                                        <div class="border rounded p-2 text-center" style="max-width: 200px;">
                                            <img src="{{ $feature->icon_url }}" alt="Current Icon" class="img-fluid" style="max-height: 100px;">
                                        </div>
                                    </div>
                                @endif
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-check"></i> Update Special Feature
                                    </button>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('#specialFeatureForm').on('submit', function(e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "Do you want to update this special feature?",
            icon: 'question',
