...
@section('title', 'Create Website Benefit')
...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Create Website Benefit</h2>
            <nav>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Create Website Benefit</h5>
                    <a href="{{ route('admin.website-benefits.index') }}" class="btn btn-secondary">
                        <i class="ti ti-arrow-left"></i> Back to Website Benefits
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.website-benefits.store') }}" method="POST" enctype="multipart/form-data" id="websiteBenefitForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-check"></i> Create Website Benefit
                                    </button>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('#websiteBenefitForm').on('submit', function(e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "Do you want to create this website benefit?",
            icon: 'question',
