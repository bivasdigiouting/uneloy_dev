        ...
        <div class="my-auto mb-2">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Lead Master</li>
                </ol>
            </nav>
        </div>
        <div class="ms-2">
            <a href="{{ route('admin.leads.create') }}" class="btn btn-primary"><i class="ti ti-plus"></i> Add Lead</a>
        </div>
    </div>
...
$(function () {
    ...
    $(document).on('click', '.toggle-lead-status', function () {
        const id = $(this).data('id');
