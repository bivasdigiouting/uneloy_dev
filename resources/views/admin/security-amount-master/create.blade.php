...
@section('title', 'Add Security Amount Setting')
...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Add Security Amount Setting</h2>
            <nav>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.security-amount-master.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('state_level_amount') is-invalid @enderror" 
                                               ...
                                               value="{{ old('state_level_amount', '0.00') }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('district_level_amount') is-invalid @enderror" 
                                               ...
                                               value="{{ old('district_level_amount', '0.00') }}" 
                                               step="0.01" min="0" required>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('block_level_amount') is-invalid @enderror" 
                                               ...
                                               value="{{ old('block_level_amount', '0.00') }}" 
                                               step="0.01" min="0" required>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('panchayat_level_amount') is-invalid @enderror" 
                                               ...
                                               value="{{ old('panchayat_level_amount', '0.00') }}" 
                                               step="0.01" min="0" required>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('village_level_amount') is-invalid @enderror" 
                                               ...
                                               value="{{ old('village_level_amount', '0.00') }}" 
                                               step="0.01" min="0" required>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ti ti-device-floppy"></i> Save Setting
                                    </button>
                                </div>
                            </div>
                        </div>
