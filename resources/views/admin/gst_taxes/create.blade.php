...
@section('title', 'Add GST Tax Rate')

@section('content')
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Create GST Tax Rate</h2>
            <nav>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.gst-taxes.store') }}" method="POST" id="gstTaxForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="tax_name" class="form-label">Tax Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('tax_name') is-invalid @enderror" id="tax_name" name="tax_name" value="{{ old('tax_name') }}" placeholder="e.g., GST 18%" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" max="100" class="form-control @error('rate_percent') is-invalid @enderror" id="rate_percent" name="rate_percent" value="{{ old('rate_percent') }}" placeholder="e.g., 18" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="ti ti-check me-1"></i> Create GST Tax</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
$(document).ready(function() {
    $('#gstTaxForm').on('submit', function(e) {
