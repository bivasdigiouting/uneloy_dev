...
@section('title', 'Add/Remove User Wallet')
...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Add/Remove User Wallet</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add/Remove User Wallet</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.wallet.search') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="search_id" class="form-label">Search by ID/User ID/Aadhaar/Mobile/Name/Email <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('search_id') is-invalid @enderror" 
                                           ...
                                           placeholder="Enter ID/User ID/Aadhaar/Mobile/Name/Email" required>
                                    @error('search_id')
    ...
    <!-- User Details and Wallet Management -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">User Wallet Management</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.wallet.transaction') }}" method="POST" id="walletForm">
                        @csrf
                                ...
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{ $registration->id }}" readonly>
                                        </div>

                                        <div class="form-group mb-3">
                                            <label class="form-label">User ID</label>
                                            <input type="text" class="form-control" value="{{ $registration->user_id }}" readonly>
                                        </div>
                                        
                                        <div class="form-group mb-3">
                                            <label class="form-label">Name</label>
                                            <input type="text" class="form-control" value="{{ $registration->full_name }}" readonly>
                                        </div>

                                        <div class="form-group mb-3">
                                            <label class="form-label">Email</label>
                                            <input type="text" class="form-control" value="{{ $registration->email_id }}" readonly>
                                        </div>

                                        <div class="form-group mb-3">
                                            <label class="form-label">Mobile</label>
                                            <input type="text" class="form-control" value="{{ $registration->mobile_no }}" readonly>
                                        </div>
                                        
                                        <div class="form-group mb-3">
                                            <label class="form-label">Available Amount</label>
                                            <input type="text" class="form-control" value="₹{{ number_format($availableAmount ?? ($registration->wallet_balance ?? 0), 2) }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @if(!isset($registration) && request()->has('search_id'))
    <!-- No User Found Message -->
    <div class="row">
        <div class="col-12">
            <div class="alert alert-warning">
                <i class="fas fa-exclamation-triangle"></i> No user found with the provided search criteria.
            </div>
        </div>
    </div>
    @endif
...
$(document).ready(function() {
    ...
    $('#walletForm').on('submit', function(e) {
        ...
        const userName = '{{ isset($registration) ? $registration->full_name : "" }}';
        
        const confirmMessage = `Are you sure you want to ${transactionType} ₹${transactionAmount} ${transactionType === 'add' ? 'to' : 'from'} ${userName}'s wallet?`;
