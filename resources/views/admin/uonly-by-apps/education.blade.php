...
@section('title', 'Uonly By Apps - Education')

@section('content')
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Uonly By Apps - Education</h2>
            <nav>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title mb-0">Edit Education</h4>
                        </div>
                    </div>
                </div>
                <form action="{{ route('website-uonly-by-apps.education.update') }}" method="POST" enctype="multipart/form-data" id="uonlyByAppsEducationForm">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group text-end">
                                    <button type="submit" class="btn btn-primary"><i class="ti ti-device-floppy me-1"></i>Update Education</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $('#uonlyByAppsEducationForm').on('submit', function(e) {
        e.preventDefault();
        Swal.fire({
