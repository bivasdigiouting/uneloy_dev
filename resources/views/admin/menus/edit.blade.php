            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title mb-0">Edit Menu Item: {{ $menu->title }}</h4>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('menu_type') is-invalid @enderror" 
                                        ...
                                        <option value="primary" {{ old('menu_type', $menu->menu_type) == 'primary' ? 'selected' : '' }}>
                                            Primary Menu
                                        </option>
                                        <option value="footer" {{ old('menu_type', $menu->menu_type) == 'footer' ? 'selected' : '' }}>
                                            Footer Menu
                                        </option>
                                    </select>
                                    @error('menu_type')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('parent_id') is-invalid @enderror" 
                                        ...
                                        <optgroup label="Primary Menus" id="primary-parents">
                                            @foreach($parentMenus['primary'] as $parentMenu)
                                        ...
                                        <optgroup label="Footer Menus" id="footer-parents">
                                            @foreach($parentMenus['footer'] as $parentMenu)
                                                @if($parentMenu->id !== $menu->id)
                                                    <option value="{{ $parentMenu->id }}" {{ old('parent_id', $menu->parent_id) == $parentMenu->id ? 'selected' : '' }}>
                                                        {{ $parentMenu->title }}
                                                    </option>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check-container mt-2">
                                                @php
                                                    $urlTypeSelection = old('url_type_selection', $menu->route_name ? 'route' : 'custom');
                                                @endphp
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" 
                                                           ...
                                                           id="url_type_custom" 
                                                           value="custom" 
                                                           {{ $urlTypeSelection == 'custom' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" 
                                                           ...
                                                           id="url_type_route" 
                                                           value="route" 
                                                           {{ $urlTypeSelection == 'route' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check form-switch mt-2">
                                                <input class="form-check-input" 
                                                       ...
                                                       value="1" 
                                                       {{ old('open_in_new_tab', $menu->open_in_new_tab) ? 'checked' : '' }}>
                                ...
                                <div class="card mt-3">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-2">
                                            ...
                                            <span class="text-dark">{{ $menu->created_at->format('M d, Y h:i A') }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <small class="text-muted">Last Updated:</small><br>
                                            <span class="text-dark">{{ $menu->updated_at->format('M d, Y h:i A') }}</span>
                                        </div>
                                        @if($menu->children->count() > 0)
                                            <div class="mb-2">
                                                <small class="text-muted">Sub-menus:</small><br>
                                                <span class="badge bg-info">{{ $menu->children->count() }} items</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ti ti-device-floppy me-1"></i>Update Menu
                            </button>
                        </div>
                    </div>
                </form>
