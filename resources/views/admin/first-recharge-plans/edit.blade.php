...
@section('title', 'Edit First Recharge Plan')

@section('content')
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Edit First Recharge Plan</h2>
            <nav>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.first-recharge-plans.update', $plan->id) }}" method="POST" id="firstRechargePlanForm">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-md-6">
                        <label for="plan_name" class="form-label">Plan Name</label>
                        <input type="text" name="plan_name" id="plan_name" value="{{ old('plan_name', $plan->plan_name) }}" class="form-control" required>
                        @error('plan_name')
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" min="0" name="plan_value" id="plan_value" value="{{ old('plan_value', (string) $plan->plan_value) }}" class="form-control" required>
                        @error('plan_value')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" min="0" name="bonus_value" id="bonus_value" value="{{ old('bonus_value', (string) $plan->bonus_value) }}" class="form-control" required>
                        @error('bonus_value')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" min="0" name="total_value" id="total_value" value="{{ old('total_value', (string) $plan->total_value) }}" class="form-control" readonly>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" name="benefit_amount" id="benefit_amount" value="{{ old('benefit_amount', (string) $plan->benefit_amount) }}" class="form-control" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="1" min="1" max="100" name="benefit_duration_years" id="benefit_duration_years" value="{{ old('benefit_duration_years', (string) $plan->benefit_duration_years) }}" class="form-control" required>
