        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Expense Information</h4>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           class="form-control" 
                                           value="{{ $expense->created_at->format('d M Y, h:i A') }}" 
                                           readonly>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{ route('admin.expenses.show', $expense->id) }}" class="btn btn-info ml-2">
