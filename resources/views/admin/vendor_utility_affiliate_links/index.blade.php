...
@section('title', 'Vendor Utility & Affiliate Link')
...
<div class="content container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Vendor Utility & Affiliate Link</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item">Vendor Management</li>
                    <li class="breadcrumb-item active">Vendor Utility & Affiliate Link</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.vendor.utility-affiliate-links.store') }}" method="POST" id="vendorUtilityAffiliateForm">
                        @csrf
                        <input type="hidden" name="audience_type" value="Vendor">
                        <div class="row">
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Vendor Utility & Affiliate Links</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="vendorUtilityAffiliateTable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>States</th>
...
$(function(){
    ...
    // DataTable
    const table = $('#vendorUtilityAffiliateTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route('admin.vendor.utility-affiliate-links.data') }}',
        columns: [
            { data: 'id', name: 'id' },
