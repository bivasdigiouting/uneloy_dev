...
@section('title', 'Add Recharge Operator')

@section('content')
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Add Recharge Operator</h2>
            <nav>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.recharge-operators.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="operator_name" id="operator_name" value="{{ old('operator_name') }}" class="form-control" required>
                        @error('operator_name')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" name="operator_code" id="operator_code" value="{{ old('operator_code') }}" class="form-control" required>
