...
@section('title', 'Social Media Master')

@section('content')
<div class="content">
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Social Media Master</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Social Media Master</li>
                </ol>
            </nav>
        </div>
        <div class="ms-2">
            <a href="{{ route('admin.social-media.create') }}" class="btn btn-primary"><i class="ti ti-plus"></i> Add Social Media</a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table id="social-media-table" class="table table-striped w-100">
                    <thead>
                        <tr>
                            <th>S.No</th>
...
<script>
$(function () {
    const table = $('#social-media-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: '{{ route('admin.social-media.data') }}',
            type: 'GET',
            error: function(xhr) {
                if (xhr.status === 401) {
    ...
    $(document).on('click', '.toggle-social-media-status', function () {
        const id = $(this).data('id');
