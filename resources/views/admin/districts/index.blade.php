...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">District Management</h2>
            <nav>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title mb-0">Districts List</h4>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="districtsTable" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>District Name</th>
...
$(document).ready(function() {
    ...
    var table = $('#districtsTable').DataTable({
        ...
        order: [[1, 'asc']], // Sort by district_name
        pageLength: 25,
        ...
        language: {
            ...
            emptyTable: "No districts available"
        }
    });
