...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Edit District</h2>
            <nav>
        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
            <div class="me-2 mb-2">
                <a href="{{ route('admin.districts.show', $district->id) }}" class="btn btn-info d-inline-flex align-items-center">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title mb-0">Edit District: {{ $district->district_name }}</h4>
                        </div>
                        <div class="col-auto">
                            <div class="btn-group" role="group">
                                <a href="{{ route('admin.districts.show', $district->id) }}" class="btn btn-info btn-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.districts.update', $district->id) }}" method="POST" id="districtForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <!-- State Selection -->
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" 
                                                   ...
                                                   {{ old('status', $district->status) == 'active' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" 
                                                   ...
                                                   {{ old('status', $district->status) == 'inactive' ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mt-2">
                                        <small class="text-muted">
                                            <strong>Created:</strong> {{ $district->created_at->format('d M Y, h:i A') }}<br>
                                            <strong>Last Updated:</strong> {{ $district->updated_at->format('d M Y, h:i A') }}
                                        </small>
                                    </div>
                                </div>
                            </div>
