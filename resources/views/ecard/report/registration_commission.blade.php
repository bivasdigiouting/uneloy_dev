...
@section('title', 'Registration Commission')
    ...
    <div class="content-inner">
        <div class="container-fluid py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="fw-bold mb-0 text-dark">Registration Commission Earnings</h4>
            </div>
...
<script>
    $(function () {
        const table = $('#commissionTable').DataTable({
            ...
            ajax: {
                url: "{{ route('ecard.report.registration-commission.data') }}",
                data: function (d) {
