...
@section('title', 'Coupon Summary Detail Report')
    ...
    <div class="gradient-hero">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h3 class="mb-1">Coupon Summary Detail Report</h3>
                    <p class="mb-0">Track coupon performance and redemptions across time.</p>
                </div>
                <div class="ms-auto d-none d-md-block">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active text-white" aria-current="page">Coupon Summary</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    <div class="col-12 col-md-4">
                        <label class="form-label">Search coupon code</label>
                    ...
                    <div class="col-6 col-md-3">
                        <label class="form-label">Redeemed min</label>
                        ...
                        <tbody>
                            @forelse($coupons as $row)
                                <tr>
                                    <td>{{ $row['code'] }}</td>
                                    <td>{{ $row['discount'] }}</td>
                                    <td class="text-end">{{ number_format($row['redeemed']) }}</td>
                                </tr>
                            @empty
                                <tr>
