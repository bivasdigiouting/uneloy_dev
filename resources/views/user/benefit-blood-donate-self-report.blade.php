...
<head>
    ...
    <title>Benefit - Blood Donate Self Req. Report</title>
...
<body>
    ...
    <div class="container py-4">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h2 class="page-title">Blood Donate Self Req. Report</h2>
        </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped">
                        <thead><tr><th>Date</th><th>Blood Group</th><th>Status</th></tr></thead>
                        <tbody>
