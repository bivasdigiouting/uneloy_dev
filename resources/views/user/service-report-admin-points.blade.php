...
@section('title', 'Admin by Points Report - UOnly')
    ...
    <div class="card welcome-card">
        <div class="card-body p-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="mb-1">Admin by Points Report</h3>
                    <p class="mb-0">View points accumulated by admins in the selected period.</p>
                </div>
                <div class="ms-auto d-none d-md-block">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active text-white" aria-current="page">Admin by Points</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table align-middle">
                    ...
                    <tbody>
                        @forelse($rows as $row)
                            <tr>
                                <td class="fw-semibold">{{ $row['admin'] }}</td>
