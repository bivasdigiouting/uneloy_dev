...
@section('title', 'Physically Challenged Fund Report')
    ...
    <div class="gradient-hero">
        <div class="container">
            <div class="d-flex align-items-center">
                <div class="page-icon"><i class="fas fa-universal-access"></i></div>
                <div>
                    <h3 class="mb-1">Physically Challenged Fund Report</h3>
                    <p class="mb-0">View support disbursements by benefit and date range.</p>
                </div>
                <div class="ms-auto d-none d-md-block">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active text-white" aria-current="page">Physically Challenged Fund</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    <div class="col-12 col-md-4">
                        ...
                        <input type="text" class="form-control" placeholder="Search benefit type">
                    </div>
